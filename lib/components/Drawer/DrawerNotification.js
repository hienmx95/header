...
var DrawerNotification = function (_React$Component) {
  ...
  function DrawerNotification(props) {
    ...
    _this.getNotification = function () {
      ...
      (0, _frontendHelper.fetchAPI)({
        ...
        var allProject = _this.props.allProject;

        var notifications = _this.state.notifications.concat(res.data.data);
        notifications.forEach(function (notify) {
          var newNotify = allProject.find(function (project) {
            return notify.service.toLowerCase() === project.projectId.toLowerCase();
          });
          if (newNotify) {
            notify.logoImage = newNotify.icon;
          }
        });
        ...
        if (res.data.data.length < 20) {
          _this.isLastNotification = true;
        }

        if (!lastCreatedAt) {
          var elmNotification = document.getElementsByClassName('tab-notification');
          if (elmNotification.length) {
            _this.elmNotification = elmNotification[0];
            _this.elmNotification.addEventListener('scroll', _this.handleScrollNotification, true);
          }
        }
    ...
    _this.getAnnouncement = function () {
      ...
      (0, _frontendHelper.fetchAPI)({
        ...
        announcements.forEach(function (notify) {
          var newNotify = allProject.find(function (project) {
            return notify.service.toLowerCase() === project.projectId.toLowerCase();
          });
          if (newNotify) {
  ...
  DrawerNotification.prototype.render = function render() {
    ...
    var operations = _react2.default.createElement(_MoreOption2.default, { onClose: onClose, markAsRead: this._markAsReadAll });
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          TabPane,
          { className: 'tab-notification', tab: _i18next2.default.t('header:system') + ' (' + numberOfNotificationText + ')',
            key: '1' },
