...
var DrawerNotification = function (_React$Component) {
  ...
  DrawerNotification.prototype.render = function render() {
    ...
    var operations = React.createElement(MoreOption, { onClose: onClose, markAsRead: this._markAsReadAll });
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          TabPane,
          { className: 'tab-notification', tab: i18n.t('header:system') + ' (' + numberOfNotificationText + ')',
            key: '1' },
